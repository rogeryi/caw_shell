...
namespace {
const char kPowerMonitorClassPath[] =
    "org/chromium/base/PowerMonitor";
...
static void OnMainActivitySuspended(JNIEnv* env, jclass clazz);

static void OnMainActivityResumed(JNIEnv* env, jclass clazz);
