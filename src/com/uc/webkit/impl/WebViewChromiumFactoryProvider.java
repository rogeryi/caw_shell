...
import com.uc.webkit.WebIconDatabase;
import com.uc.webkit.WebStorage;
import com.uc.webkit.WebView;
import com.uc.webkit.WebViewDatabase;
import com.uc.webkit.WebViewFactoryProvider;
import com.uc.webkit.WebViewProvider;
...
import com.uc.webkit.helper.ActivityThreadHelper;
...
public class WebViewChromiumFactoryProvider implements WebViewFactoryProvider {
	...
	private final boolean IS_DEBUGGABLE = com.uc.webkit.DebugFlags.DEBUG_FACTORY;
    ...
    private void startChromiumLocked() {
        ...
        AwBrowserProcess.start(ActivityThreadHelper.currentApplication());
    ...
    private AwBrowserContext getBrowserContextLocked() {
        ...
        if (mBrowserContext == null) {
            mBrowserContext = new AwBrowserContext(
                    ActivityThreadHelper.currentApplication().getSharedPreferences(
        ...
        synchronized (mLock) {
            if (mCookieManager == null) {
                if (!mStarted) {
                    ...
                    ContentMain.initApplicationContext(ActivityThreadHelper.currentApplication());
                }
