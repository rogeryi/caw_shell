...
public class FindActionModeCallback implements ActionMode.Callback, TextWatcher,
    ...
    private void updateMatchesString() {
        if (mNumberOfMatches == 0) {
            ...
            mMatches.setText(String.format("%d of %d", mNumberOfMatches, mActiveMatchIndex + 1, mNumberOfMatches));
        }
    ...
    public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
        ...
        /* FIXME - roger (roger2yi@gmail.com)
            case android.internal.R.id.find_prev:
                findNext(false);
                break;
